...
var (
	userAllColumns            = []string{"id", "name", "email", "status", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "email", "status"}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to populate default values for users")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to retrieve unique values for users")
	}
